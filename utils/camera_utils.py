...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    if getattr(cam_info, "valid_mask", None) is not None:
        resized_valid_mask = PILtoTorch(cam_info.valid_mask, resolution)
    else:
        resized_valid_mask = None
    ...
    return Camera(colmap_id=cam_info.uid, pose_id=cam_info.pose_id, R=cam_info.R, T=cam_info.T, K=cam_info.K,
                  ...
                  bound_mask=resized_bound_mask, valid_mask=resized_valid_mask, smpl_param=cam_info.smpl_param,
